...
from flask import Flask, request, render_template, abort, send_file, url_for, flash, redirect
from source.logger import logging
from source.exception import FaceDetectionException
from source.components.face_detect_imagges import FaceDetectionImage
from source.components.face_detect_webcam import FaceDetectionWebcam
...
if not os.path.exists('uploads'):
    os.makedirs('uploads')
    #creating a upload folder if it is not present
