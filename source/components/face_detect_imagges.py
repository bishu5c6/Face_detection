...
class FaceDetectionImage:
    ...
    def display_image(self) :
        try:
            ...
            # Will print shape of numpy array ie(426,500), simply original image we are resizing here
...
#Note : we will always do the detction in the gray scale image
#1. we are converting the original image to gray scale image
#2. calculting the coordinates after converting image to gray scale(eyes,nose,mouth,top &below corner,height,width..)
